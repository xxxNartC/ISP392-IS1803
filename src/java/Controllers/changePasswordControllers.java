 ...
 * @author DELL
 */
@WebServlet(name = "changePasswordControllers", urlPatterns = {"/changePasswordControllers"})
public class changePasswordControllers extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet changePasswordControllers</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet changePasswordControllers at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (acc != null && acc.getPassword().equals(currentPassword)) {
            ...
            boolean success = d.updateUser(acc);

            if (success) {
                session.setAttribute("account", acc); // Update session with new account info
